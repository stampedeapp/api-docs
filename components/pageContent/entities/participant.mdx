...
<Property name="applicationId" type="ID | undefined">
  If the booking was generated via an application, the unique identifier for
  that application.
</Property>
...
<Property name="booker" type="Booker | undefined">
